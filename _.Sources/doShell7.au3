...
#AutoIt3Wrapper_Outfile_x64=..\..\InfinityPE.Shell7.exe
#AutoIt3Wrapper_Change2CUI=y
#AutoIt3Wrapper_Res_Description=InfinityPE Shell7 Init
#AutoIt3Wrapper_Res_Fileversion=1.0.0.0
#AutoIt3Wrapper_Res_ProductName=InfinityPE.Shell7
...
Global Const $sAlias="InfinityPE.Shell7"
...
RunWait(@SystemDir&'\rundll32.exe '&@SystemDir&'\themecpl.dll,OpenThemeAction '&@WindowsDir&'\Resources\Themes\Shell7.theme',@SystemDir,@SW_SHOW)

; Configure DWMBlurGlass
ConsoleWrite("Configuring DWM..."&@CRLF)
ConsoleWrite($sAgConf&@CRLF)
IniWrite($sAgConf,"config","oldBtnHeight","true")
IniWrite($sAgConf,"config","titleBtnOffsetX","7")
IniWrite($sAgConf,"config","titlebtnGlow","true")
RunWait("Taskkill /f /im dwm.exe",@SystemDir,@SW_SHOW)
RunWait($sAgExec,@SystemDir,@SW_SHOW)
ConsoleWrite("Configuring Explorer7..."&@CRLF)
RunWait('Reg Import "'&$sAppPath&'\Import Me.reg"',@SystemDir,@SW_SHOW)
RegWrite("HKCU\Software\Microsoft\Windows NT\CurrentVersion\Winlogon","Shell","REG_SZ",$sAppExec)
RegWrite("HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced","OrbFolder","REG_SZ","Default")
...
RunWait("Taskkill /f /im StartMenu.exe",@SystemDir,@SW_SHOW)
